  ...
  data.forEach(request => {
    ...
    if (auxCP !== null && auxCS !== null && auxProfessionalAssign !== null) {
      requestsMapped.push({
        ...
        fecha_servicio_solicitado: moment(request.fecha_servicio_solicitado, FORMAT_DATE).format(FORMAT_DATE) || moment().format(FORMAT_DATE),
        hora_servicio_solicitado: request.hora_servicio_solicitado || moment().format('HH:mm'),
        fecha_servicio_solicitado_termino: moment(request.fecha_servicio_solicitado_termino, FORMAT_DATE).format(FORMAT_DATE) || moment().format(FORMAT_DATE),
        hora_servicio_solicitado_termino: request.hora_servicio_solicitado_termino || moment().format('HH:mm'),
        jornada: '',
        estado: 'Ingresado',
        isActive: true,
        url_file_adjunto: {}
