...
router.post('/evaluacionpsico', async (req, res) => {
  ...
  const nameFIle = `${firstPartFileName}_${secondPartFileName}_${thirdPartFileName}_${fourthPartFileName}_${fifthPartFileName}.pdf`;
  ...
  try {
    ...
    if (cp && cs) {
      const informacionPersonal = {
        ...
        rut: cs.rut || '',
        fecha_nacimiento: cs.fecha_inic_mac ? moment(cs.fecha_inic_mac, FORMAT_DATE).format(FORMAT_DATE) : '',
        cargo: cs.cargo || '',
