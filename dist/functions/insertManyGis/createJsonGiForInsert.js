...
exports["default"] = createGIs;

function createGIs(empresas, personas) {
  var array_final = [];
  var obj = {};
  empresas.forEach(function (element) {
    ...
    obj.edad_gi = 0;
    obj.contacto = element.contacto, obj.contacto_2 = element.contacto_2 || 0, obj.email_central = element.email_central;
  ...
  personas.forEach(function (element) {
    ...
    obj.grupo_interes = element.grupo_interes;
    obj.categoria = element.categoria;
    obj.categoria_empresa = "No Aplica", obj.categoria_cliente = element.categoria_cliente;
    obj.fecha_inic_mac = element.fecha_inic_mac;
    obj.edad_gi = 0;
    obj.contacto = element.contacto, obj.contacto_2 = element.contacto_2 || 0, obj.email_central = element.email_central;
    obj.email_encargado = element.email_encargado;
    obj.profesion_oficio = "";
    obj.direccion = element.direccion || '', obj.localidad = element.localidad;
    obj.comuna = element.comuna;
    obj.provincia = element.provincia;
    obj.region = element.region;
    obj.sector = element.sector;
    ...
    obj.id_GI_org_perteneciente = "", obj.razon_social_org_perteneciente = "", obj.url_file_adjunto = {};
    obj.activo_inactivo = true;
    array_final.push(obj);
    obj = {};
  });
