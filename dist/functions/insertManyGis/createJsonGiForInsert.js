...
function createGIs(empresas, personas) {
  ...
  empresas.forEach(function (element) {
    ...
    obj.edad_gi = 0;
    obj.contacto = element.ContactoPrimario, obj.contacto_2 = element.ContactoSecundario;
  ...
  personas.forEach(function (element) {
    ...
    obj.grupo_interes = element.GrupoInteres;
    obj.categoria = element.TipoCliente;
    obj.categoria_empresa = "No Aplica", obj.categoria_cliente = element.CategoriaCliente;
    obj.fecha_inic_mac = element.FechaInicio;
    obj.edad_gi = 0;
    obj.contacto = element.ContactoPrimario, obj.contacto_2 = element.ContactoSecundario;
    obj.email_central = element.CorreoPrimario;
